...
public class Student { // 学生信息表
	...
	private String buildingName; // 宿舍楼编号
	private String roomNum; // 寝室号
	private String bedNum; // 床号
	private String TC; // 特长
	private String sfps; // 是否贫困
	private String motherWorkplace; // 母亲工作单位
	private String fatherWorkplace;// 父亲工作单位
	private String studyType; // 学制
