...
$(function(){
	  $.ajax({
		  ...
		  success:function(data){
			  if(data=="no"){
				  window.location.href="login_jsp";
			  }
		  }
	  })
  })
		 ...
		 $("#teacherUser").modal({
	         ...
	         $.ajax({
	        	 ...
	        	 success:function(data){
	        		 ...
	        		 for(var i=0;i<data.length;i++){
	        			 var tr = $("<tr></tr>");
	        			    tr.html("<td>"+data[i].teacher+"</td><td class='deleteTuser'>删除</td>");
	        			    table.append(tr);
	        		 }    
		 ...
		 $("#teacherInfo").modal({
	         ...
	         $.ajax({
	        	 ...
	        	 success:function(data){
	        		 ...
	        		 for(var i = 0;i<data.length;i++){
	        			 var tr = $("<tr></tr>");
	        			     tr.html("<td>"+data[i].teacherName+"</td><td>"+data[i].position+"</td><td>"+data[i].officeSpace+"</td><td>"+data[i].responsibility+"</td><td>"+data[i].phone+"</td><td tid="+data[i].teacherId+" class='deleteTearcherInfo'>删除</td>");
	        		     table.append(tr);
	        		 }
	        		 //删除一条教师信息
	    	  ...
	    	  $.ajax({url: "getStudentByBuilding2",
		 	         ...
		 	         success: function(data){
		 	            ...
		 	            for(var i=0;i<list.length;i++){
		 	          	 ...
		 	          	 tr.html("<input class='compareBox' type='checkbox' value="+list[i].studentNo+"><td class='personPage'>"+list[i].studentNo+"</td><td>"+list[i].studentName+'</td><td>'+list[i].sex+'</td><td>'+list[i].major+'</td><td>'+list[i].className+'</td><td>'+list[i].phone+'</td><td style="display:none">'+list[i].qq+'</td>'
...
function createXJZCTable(data){
 ...
 for(var i=0;i<p0.length;i++){
	 var tr = $("<tr><td><input class='compareBox' type='checkbox' value="+p0[i].studentNo+"></td><td  class='personPage'>"+p0[i].studentNo+"</td><td>"+p0[i].studentName+"</td><td>"+p0[i].major+"</td><td>"+p0[i].className+"</td><td>"+p0[i].zcyear+"</td><td>"+p0[i].term+"</td></tr>");
     table.append(tr);
 };
...
function createPsStudentTable(data){
     ...
     table.append(tr);
 for(var i=0;i<p0.length;i++){
	 var tr = $("<tr><td><input class='compareBox' type='checkbox' value="+p0[i].studentNo+"></td><td  class='personPage'>"+p0[i].pstudentNo+"</td><td>"+p0[i].studentName+"</td><td>"+p0[i].major+"</td><td>"+p0[i].className+"</td><td>"+p0[i].zzname+"</td><td>"+p0[i].zztime+"</td></tr>");
     table.append(tr);
 };
}
...
$(function(){
	...
	//	 alert(major+nianji+className+type);
			 ...
			 $.ajax({url: "getPsStudentByType",
		           ...
		           scriptCharset: 'utf-8',
		           success: function(data){
		        		 var p0 = data.list;console.log(data);
		        	     clear();
		        	     var table=$("#displayTable");
		        	     table.html(" ");
		        	     ...
		        	     table.append(tr);
		        	 for(var i=0;i<p0.length;i++){
		        		 var tr = $("<tr><td><input class='compareBox' type='checkbox' value="+p0[i].studentNo+"></td><td  class='personPage'>"+p0[i].pstudentNo+"</td><td>"+p0[i].studentName+"</td><td>"+p0[i].major+"</td><td>"+p0[i].className+"</td><td>"+p0[i].zzname+"</td><td>"+p0[i].zzmoney+"</td><td>"+p0[i].zztime+"</td></tr>");
		        	     table.append(tr);
		        	 };clicktd();
		        	   var pageNow = data.pageNum;
		        	    var pageTotal = data.pages;
...
function createSkillTable(data){
     ...
     table.append(tr);
 for(var i=0;i<p0.length;i++){
	 var tr = $("<tr><td><input class='compareBox' type='checkbox' value="+p0[i].studentNo+"></td><td  class='personPage'>"+p0[i].studentNo+"</td><td>"+p0[i].studentName+"</td><td>"+p0[i].major+"</td><td>"+p0[i].className+"</td><td>"+p0[i].skillName+"</td><td>"+p0[i].skillType+"</td><td>"+p0[i].gettime+"</td></tr>");
     table.append(tr);
 };
}
...
function createPracticeTable(data){
     ...
     table.append(tr);
 for(var i=0;i<p0.length;i++){
	 var tr = $("<tr><td><input class='compareBox' type='checkbox' value="+p0[i].studentNo+"></td><td  class='personPage'>"+p0[i].studentNo+"</td><td>"+p0[i].studentName+"</td><td>"+p0[i].major+"</td><td>"+p0[i].className+"</td><td>"+p0[i].practiceName+"</td><td>"+p0[i].type+"</td><td>"+p0[i].startTime+"</td><td>"+p0[i].endTime+"</td></tr>");
     table.append(tr);
 };
...
function createJLtable(data){
     ...
     table.append(tr);
     for(var i=0;i<p0.length;i++){
    	 var tr = $("<tr><td><input class='compareBox' type='checkbox' value="+p0[i].studentNo+"></td><td class='personPage'>"+p0[i].studentNo+"</td><td>"+p0[i].studentName+"</td><td>"+p0[i].major+"</td><td>"+p0[i].className+"</td><td>"+p0[i].jlname+"</td><td>"+p0[i].jllevel+"</td><td>"+p0[i].getTime+"</td></tr>");
         table.append(tr);
     };	 
}
//高级奖励查询
		 ...
		 if(time=="All"){
			 ...
			 $.ajax({url: "getJLByType",
		           ...
		           success: function(data){
		        	     ...
		        	     table.append(tr);
		        	     for(var i=0;i<p0.length;i++){
		        	    	 var tr = $("<tr><td><input class='compareBox' type='checkbox' value="+p0[i].studentNo+"></td><td class='personPage'>"+p0[i].studentNo+"</td><td>"+p0[i].studentName+"</td><td>"+p0[i].major+"</td><td>"+p0[i].className+"</td><td>"+p0[i].jlname+"</td><td>"+p0[i].jllevel+"</td><td>"+p0[i].adviser+"</td><td>"+p0[i].sponsor+"</td><td>"+p0[i].getTime+"</td></tr>");
		        	         table.append(tr);
		        	     };	clicktd(); 
		        	   var pageNow = data.pageNum;
		        	    var pageTotal = data.pages;
...
//创建高级查询的惩罚表
    function createPunishTable(data){
	             ...
	             var table=$("#displayTable");
                     ...
                     table.append(tr);
	             for(var i=0;i<p0.length;i++){
	            	 var tr = $("<tr><td><input class='compareBox' type='checkbox' value="+p0[i].studentNo+"></td><td  class='personPage'>"+p0[i].studentNo+"</td><td>"+p0[i].studentName+"</td><td>"+p0[i].major+"</td><td>"+p0[i].className+"</td><td>"+p0[i].punishName+"</td><td>"+p0[i].punishReason+"</td><td>"+p0[i].punishTime+"</td></tr>");
	                 table.append(tr);
	             };	        
	       }
            	   ...
            	   success:function(data){
            		  // console.log(data);
        			    ...
        			    $.each(input, function() {
            		        ...
            		        $("#personTutor").val(data.tutor);
            		        $("#personSpouse").val(data.spouse);
            		        var ZZMM = data.zzmm;
            		        $("#personZZMM").val(ZZMM); 
            		        ...
            		        $("#updatePerson").click(function(){
            		        	...
            		        	var personClassName =$("#personClassName").val();
		...
		$.ajax({url: "getActive",
	     ...
	     $("#personSearchGJ").click(function(){
	    	 $.ajax({url: "getLevel",
	     	     ...
	     	     $("#personSearchProject").click(function(){
	    	 $.ajax({url: "selectProject",
		           ...
		           scriptCharset: 'utf-8',
		          success: function(data){
		        	  var table =$("#personProject");	      	
		        	  var tr=$("<tr><th style='width:200px'>学号</th><th style='width:200px'>课题项目名称</th><th style='width:200px'>是否项目第一负责人</th><th style='width:200px'>时间</th><th>图片</th></tr>")
	                  table.html(" ");
		        	      table.append(tr);
	                  for(var i=0;i<data.length;i++){
	                	 ...
	                	 var tr = $("<tr><td>"+data[i].studentNo+"</td><td>"+data[i].projectName+"</td><td>"+isFirstCharge+"</td><td>"+data[i].time+"</td><td><img src="+src+"  width='200px'/></tr>"); 
	                     table.append(tr);
	                  };// console.log(data);	    		  
			   	   } ,
		           error: function(){
	     	  ...
	     	  $("#personSearchLWFB").click(function(){
	    	 $.ajax({url: "selectLWFB",
		           type:"post", 
		           dataType:"json",
		           data:{"studentNo":studentNo
		           ...
		           scriptCharset: 'utf-8',
		          success: function(data){
		        	  var table =$("#personLWFB");	      	
		        	  var tr=$("<tr><th style='width:200px'>学号</th><th style='width:200px'>文章名称</th><th style='width:200px'>类型</th><th style='width:200px'>期刊</th<th style='width:200px'>时间</th><th>图片</th></tr>")
	                  table.html(" ");
		        	      table.append(tr);
		        	      for(var i=0;i<data.length;i++){
							  var src = "image/"+data[i].studentNo+data[i].image+".jpg";
							var tr=$("<tr class='gradeA odd ' role='row'></tr>");
							tr.html('<td>'+data[i].studentNo+'</td><td>'+data[i].articleName+'</td><td>'+data[i].type+'</td><td>'+data[i].periodical+'</td><td>'+data[i].time+'</td><td><img src='+src+'  width="200px"/></td>');
							table.append(tr);
						   }	   		  
			   	   } ,
		           error: function(){
   ...
   clear();   
    for(var i=0;i<data.length;i++){ 	   
  	 ...
  	 var roomNum = data[i].buildingName+ "-"+data[i].roomNum+"-"+ data[i].bedNum;
  	   tr.html("<td><input class='compareBox' type='checkbox' value="+data[i].studentNo+"></td><td  class='personPage'>"+data[i].studentNo+"</td><td>"+data[i].studentName+'</td><td>'+data[i].sex+'</td><td>'+data[i].major+'</td><td>'+data[i].className+'</td><td>'+data[i].phone+'</td><td style="display:none">'+data[i].qq+'</td>'
	...
	$("#major").on("change",function(){
	        			...
	        			$.ajax({url: "getAll",
	        	 	       ...
	        	 	       success: function(data){
	        	 	         ...
	        	 	         for(var i=0;i<list.length;i++){
	        	 	       	  ...
	        	 	       	  var tr = $("<tr role='row'></tr>");
	        	 	       	 var roomNum = list[i].buildingName+ "-"+list[i].roomNum+"-"+ list[i].bedNum;
	        	 	       	 tr.html("<input type='checkbox' value="+list[i].studentNo+"><td class='personPage'>"+list[i].studentNo+"</td><td>"+list[i].studentName+'</td><td>'+list[i].sex+'</td><td>'+list[i].major+'</td><td>'+list[i].className+'</td><td>'+list[i].phone+'</td><td style="display:none">'+list[i].qq+'</td>'
	        	 	                    +'<td style="display:none" >'+roomNum+'</td><td style="display:none">'+list[i].personID+'</td><td style="display:none">'+list[i].mz+'</td><td style="display:none">'+list[i].zzmm+'</td><td style="display:none">'+list[i].address+'</td><td style="display:none" class="tr_awards" sid='+list[i].studentNo+'>获奖详情</td><td style="display:none" class="tr_punish" sid='+list[i].studentNo+'>处分明细</td>'
	        	 	    	   			+'<td style="display:none" class="tr_level" sid='+list[i].studentNo+'>过级详细</td><td style="display:none" class="tr_office" sid='+list[i].studentNo+'>任职详情</td><td style="display:none" class="tr_active" sid='+list[i].studentNo+'>校外活动详情</td><td style="display:none" >'+list[i].tc+'</td><td style="display:none" class="tr_grade" sid='+list[i].studentNo+'>成绩详细</td><td style="display:none">'+list[i].sfps+'</td><td style="display:none" class="tr_help" sid='+list[i].studentNo+' >补助详细</td><td>'
	        	 	    	   		+list[i].fatherName+"</td><td>"+list[i].fatherPhone+"</td><td>"+list[i].fatherWorkplace+"</td><td>"+list[i].motherName+"</td><td>"+list[i].motherPhone+"</td><td>"+list[i].motherWorkplace+"</td><td>"+list[i].studyType+"</td>");  
	        	 	       	  table.append(tr);
	          ...
	          $.ajax({ url: "getclass",
	    	       ...
	    	       success: function(data){
	                 ...
	                 var cl =$("#classNo");
	                   cl.html(" ");
	                   cl.append("<option value='null'>请选择班级</option>")
		  ...
		  $.ajax({
			  ...
			  success:function(data){
				  var table=$("#xjyd_table");
				     ...
				     table.append(tr);
				 for(var i=0;i<data.length;i++){
					 var tr = $("<tr><td  class='personPage'>"+data[i].studentNo+"</td><td>"+data[i].studentName+"</td><td>"+data[i].major+"</td><td>"+data[i].className+"</td><td>"+data[i].bz+"</td><td>"+data[i].ydreason+"</td><td>"+data[i].ydtime+"</td></tr>");
				     table.append(tr);
				 };
			    ...
			    $(".afert_alert").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		//	alert(data);//data[0]为修改后的数据，data[1]为修改前的数据
			    		  ...
			    		  $("#before_className").html(data[1].className);$("#after_className").html(data[0].className);
			    		  ...
			    		  $("#before_tutor").html(data[1].tutor);$("#after_tutor").html(data[0].tutor);
			    		  $("#before_spouse").html(data[1].spouse);$("#after_spouse").html(data[0].spouse);
